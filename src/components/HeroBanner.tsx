...
import type { CmsBannerSlide } from '@/lib/types'

const defaultSlides: CmsBannerSlide[] = [
  {
    id: 'default-1',
    ...
    href: '/products',
    imageUrl: 'https://images.unsplash.com/photo-1604079628040-94301bb21b91?w=1400&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=1400&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    cta: 'Get a Quote',
    href: '/contact',
    imageUrl: 'https://images.unsplash.com/photo-1545093149-618ce3bcf49d?w=1400&q=80&auto=format&fit=crop',
...
export default function HeroBanner({ slides: propSlides }: Props) {
  ...
  return (
    ...
    >
      {slides.map((s, i) => (
        ...
        >
          {Math.abs(i - current) <= 1 && s.imageUrl && (
            <Image
              src={s.imageUrl}
